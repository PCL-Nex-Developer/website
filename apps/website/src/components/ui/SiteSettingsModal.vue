...
import {
	type DownloadSource,
	useDownloadSource,
} from '~/composables/use-download-source'
...
const supportedLocales = LOCALES.filter((item) =>
	['en-US', 'zh-CN'].includes(item.code),
)
const changingLocale = ref(false)
const activeTab = ref<SettingsTab>('appearance')

const messages = defineMessages({
	title: { id: 'pcl-nex-settings.title', defaultMessage: 'Display settings' },
	description: {
		id: 'pcl-nex-settings.description',
		defaultMessage: 'Customize how PCL Nex looks and reads on this device.',
	},
	close: { id: 'pcl-nex-settings.close', defaultMessage: 'Close settings' },
	appearanceTitle: {
		id: 'pcl-nex-settings.appearance.title',
		defaultMessage: 'Appearance',
	},
	languageTitle: {
		id: 'pcl-nex-settings.language.title',
		defaultMessage: 'Language',
	},
	languageDescription: {
		id: 'pcl-nex-settings.language.description',
		defaultMessage: 'Choose the language used by this website.',
	},
	downloadsTitle: {
		id: 'pcl-nex-settings.downloads.title',
		defaultMessage: 'Downloads',
	},
	downloadsDescription: {
		id: 'pcl-nex-settings.downloads.description',
		defaultMessage: 'Choose where PCL Nex installers are downloaded from.',
	},
	downloadSourceTitle: {
		id: 'pcl-nex-settings.download-source.title',
		defaultMessage: 'Download source',
	},
	downloadSourceDescription: {
		id: 'pcl-nex-settings.download-source.description',
		defaultMessage:
			'Choose the ModelScope mirror or the original GitHub Release assets.',
	},
	downloadSourceGithub: {
		id: 'pcl-nex-settings.download-source.github',
		defaultMessage: 'GitHub',
	},
	downloadSourceGithubDescription: {
		id: 'pcl-nex-settings.download-source.github.description',
		defaultMessage: 'Download from the official GitHub release.',
	},
	downloadSourceModelScope: {
		id: 'pcl-nex-settings.download-source.modelscope',
		defaultMessage: 'ModelScope',
	},
	downloadSourceModelScopeDescription: {
		id: 'pcl-nex-settings.download-source.modelscope.description',
		defaultMessage: 'Use the official mirror for faster downloads in China.',
	},
	currentDownloadSource: {
		id: 'pcl-nex-settings.download-source.current',
		defaultMessage: 'Current source: {source}',
	},
	themeTitle: {
		id: 'pcl-nex-settings.theme.title',
		defaultMessage: 'Color theme',
	},
	themeDescription: {
		id: 'pcl-nex-settings.theme.description',
		defaultMessage:
			'Select your preferred color theme for PCL Nex on this device.',
	},
	interfaceTitle: {
		id: 'pcl-nex-settings.interface.title',
		defaultMessage: 'Interface',
	},
	interfaceDescription: {
		id: 'pcl-nex-settings.interface.description',
		defaultMessage: 'Enable or disable visual behavior on this device.',
	},
	advancedRenderingTitle: {
		id: 'pcl-nex-settings.advanced-rendering.title',
		defaultMessage: 'Advanced rendering',
	},
	advancedRenderingDescription: {
		id: 'pcl-nex-settings.advanced-rendering.description',
		defaultMessage: 'Use blur, gradients, and enhanced background effects.',
	},
	reduceMotionTitle: {
		id: 'pcl-nex-settings.reduce-motion.title',
		defaultMessage: 'Reduce motion',
	},
	reduceMotionDescription: {
		id: 'pcl-nex-settings.reduce-motion.description',
		defaultMessage: 'Disable decorative movement and transition effects.',
	},
	externalLinksTitle: {
		id: 'pcl-nex-settings.external-links.title',
		defaultMessage: 'Open external links in new tab',
	},
	externalLinksDescription: {
		id: 'pcl-nex-settings.external-links.description',
		defaultMessage:
			'Keep the download page open when visiting another website.',
	},
	done: { id: 'pcl-nex-settings.done', defaultMessage: 'Done' },
})
...
>(() => [
	{
		value: 'modelscope',
		label: formatMessage(messages.downloadSourceModelScope),
		subLabel: formatMessage(messages.downloadSourceModelScopeDescription),
	},
	{
		value: 'github',
...
const resolvedDownloadSourceLabel = computed(() => {
	return formatMessage(
		selectedSource.value === 'modelscope'
...
function applyTheme() {
	...
	document.documentElement.classList.add(`${resolvedTheme}-mode`, 'accent-pcl')
	document.documentElement.style.colorScheme =
		resolvedTheme === 'light' ? 'light' : 'dark'
	localStorage.setItem('pcl-nex-theme', preferredTheme.value)
}
...
function applyRenderingPreferences() {
	...
	localStorage.setItem(
		'pcl-nex-advanced-rendering',
		String(advancedRendering.value),
	)
	localStorage.setItem('pcl-nex-reduce-motion', String(reduceMotion.value))
	localStorage.setItem(
		'pcl-nex-external-links-new-tab',
		String(externalLinksNewTab.value),
	)
}
...
watch(
	[advancedRendering, reduceMotion, externalLinksNewTab],
...
onMounted(() => {
	...
	preferredTheme.value =
		(localStorage.getItem('pcl-nex-theme') as Theme | null) ?? 'system'
	advancedRendering.value =
		localStorage.getItem('pcl-nex-advanced-rendering') !== 'false'
	reduceMotion.value = localStorage.getItem('pcl-nex-reduce-motion') === 'true'
	externalLinksNewTab.value =
		localStorage.getItem('pcl-nex-external-links-new-tab') !== 'false'
	applyTheme()
	applyRenderingPreferences()
				...
				>
					...
					<div class="settings-body">
						<aside class="settings-sidebar">
							...
							>
								<img src="/pcl-nex.png" alt="" />
								<div>
									<strong>PCL Nex</strong>
						...
						<div class="settings-main">
							<section
								...
								class="settings-pane px-8 pb-12 pl-6"
							>
									...
									<div class="mt-3 flex flex-col">
										...
										<div class="setting-row">
											<label for="reduce-motion">
												<strong>{{
													formatMessage(messages.reduceMotionTitle)
												}}</strong>
												<span>{{
													formatMessage(messages.reduceMotionDescription)
												}}</span>
											</label>
										...
										<div class="setting-row">
											<label for="external-links">
												<strong>{{
													formatMessage(messages.externalLinksTitle)
												}}</strong>
												<span>{{
													formatMessage(messages.externalLinksDescription)
												}}</span>
											</label>
											<Toggle
												id="external-links"
...
.setting-row {
	...
	border-bottom: 1px solid
		color-mix(in srgb, var(--color-divider) 68%, transparent);
